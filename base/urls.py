...
from modules.customers.views import (api_login, api_logout, get_rooms, get_relays, send_command, get_locations,
                                     ...
                                     add_new_scenario,
                                     delete_scenario, list_user_scenarios, add_relay_to_scenario,
                                     delete_relay_from_scenario,
                                     list_relay_crons, delete_relay_cron, add_new_relay_cron, list_scenario_relays,
                                     activate_scenario, list_relays)
...
urlpatterns = [
    ...
    url(r'^api/list/list_relays/$', list_relays),
